...
ApplicationWindow {
    ...
    visible: true
    title: qsTr("Speech Intonation Assistant")
    ...
    Drawer {
        ...
        Column {
            ...
            Rectangle {
                ...
                Label {
                    anchors.centerIn: parent
                    text: qsTr("Speech Intonation Assistant")
                    color: Theme.primary.titleColor
                    font.bold: true
                    font.pointSize: 18
                }
            ...
            ItemDelegate {
                width: parent.width
                onClicked: {
                    Qt.openUrlExternally("https://intontrainer.by/downloads/SpeechIntonationAssistant_UserGuide_en.pdf");
                    drawer.close()
                }
